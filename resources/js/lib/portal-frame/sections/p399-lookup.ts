...
export function lookupP399Section(
    ...
    let lookupLineLoad = snapUpToTabulated(lineLoadKnM, lineLoadsKnM);
    ...
    // section is returned rather than aborting the whole editor.
    if (lookupLineLoad === null) {
        lookupLineLoad = maxLineLoad;
    }
