...
export const OPENFREEMAP_SOURCE = 'openfreemap-buildings';
/** OpenMapTiles source-layer containing building footprints. */
export const OPENFREEMAP_BUILDING_SOURCE_LAYER = 'building';
